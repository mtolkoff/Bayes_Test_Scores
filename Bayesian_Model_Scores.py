...
if __name__ == '__main__':
    ...
    with pm.Model() as hierarchical_model:
        ...
        intercept_reading = pm.Normal('intercept_reading', intercept_mean, sd=global_shrinkage_beta * local_shrinkage_beta[0])
        lunch_reading_beta = pm.Normal('lunch_reading_beta', lunch_mean, sd=global_shrinkage_beta * local_shrinkage_beta[1])
        gender_reading_beta = pm.Normal('gender_reading_beta', gender_mean, sd=global_shrinkage_beta * local_shrinkage_beta[2])
        testPrep_reading_beta = pm.Normal('testPrep_reading_beta', testPrep_mean, sd=global_shrinkage_beta * local_shrinkage_beta[3])
        race_reading_beta = pm.Normal('race_reading_beta', race_mean, sd=global_shrinkage_beta * local_shrinkage_beta[4:8], shape=(race_OneHot.shape[1]))
        PEd_reading_beta = pm.Normal('PEd_reading_beta', PEd_mean, sd=global_shrinkage_beta * local_shrinkage_beta[8:13], shape=(PEd_OneHot.shape[1]))
        ...
        reading_score = pm.Normal('reading', mu=students_lm_reading, sd=global_shrinkage_model * local_shrinkage_model[0], observed=reading_transform)

        #Writing
        intercept_writing = pm.Normal('intercept_writing', intercept_mean, sd=global_shrinkage_beta * local_shrinkage_beta[13])
        lunch_writing_beta = pm.Normal('lunch_writing_beta', lunch_mean, sd=global_shrinkage_beta * local_shrinkage_beta[14])
        gender_writing_beta = pm.Normal('gender_writing_beta', gender_mean, sd=global_shrinkage_beta * local_shrinkage_beta[15])
        testPrep_writing_beta = pm.Normal('testPrep_writing_beta', testPrep_mean, sd=global_shrinkage_beta * local_shrinkage_beta[16])
        race_writing_beta = pm.Normal('race_writing_beta', race_mean, sd=global_shrinkage_beta * local_shrinkage_beta[17:21], shape=(race_OneHot.shape[1]))
        PEd_writing_beta = pm.Normal('PEd_writing_beta', PEd_mean, sd=global_shrinkage_beta * local_shrinkage_beta[21:26], shape=(PEd_OneHot.shape[1]))
        ...
        writing_score = pm.Normal('writing', mu=students_lm_writing, sd=global_shrinkage_model * local_shrinkage_model[1], observed=writing_transform)
        ...
        testPrep_math_beta = pm.Normal('testPrep_math_beta', testPrep_mean, sd=global_shrinkage_beta * local_shrinkage_beta[29])
        race_math_beta = pm.Normal('race_math_beta', race_mean, sd=global_shrinkage_beta * local_shrinkage_beta[30:34], shape=(race_OneHot.shape[1]))
        PEd_math_beta = pm.Normal('PEd_math_beta', PEd_mean, sd=global_shrinkage_beta * local_shrinkage_beta[34:39], shape=(PEd_OneHot.shape[1]))
        ...
        math_score = pm.Normal('math_score', mu=students_lm_math, sd=global_shrinkage_model * local_shrinkage_model[2],
